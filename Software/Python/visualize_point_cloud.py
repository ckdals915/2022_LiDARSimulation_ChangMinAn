...
def load_data(point_cloud_path):
    ...
    file_path = os.path.join(point_cloud_path) + "\\frame4200.csv"
    
    # file_path = glob.glob(point_cloud_path + '/*.csv')
    # file_path = "C:\Users\AnChangMin\source/repos\GithubDesktop/2022_LiDARSimulation_ChangMinAn\Software\Velodyne-VLP-16/test/2023-01-10_175901/2023-01-11_2037.frame4179.csv"
